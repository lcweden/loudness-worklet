...
1. Download the pre-built file from GitHub Releases: [loudness.worklet.js](https://github.com/lcweden/loudness-worklet/releases/latest/download/loudness.worklet.js).
