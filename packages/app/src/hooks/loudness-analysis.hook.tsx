import type { LoudnessMeasurements, LoudnessSnapshot } from "@loudness-worklet/lib";
...
function createLoudnessAnalysis() {
  ...
  const [getMeasurements, setMeasurements] = createSignal<LoudnessMeasurements>();
  ...
  async function analyze(buffer: AudioBuffer, options?: { capacity?: number; interval?: number }) {
